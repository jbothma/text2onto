...
java -ms2000M -mx2000M -Dgate.home=${GATE_HOME} -Dgate.config=${GATE_HOME}/gate.xml -Dgate.plugins.home=${GATE_HOME}/plugins -Dload.plugin.path=file:${GATE_HOME}/plugins/ANNIE -classpath ${T2O_CP} org.ontoware.text2onto.debug.TestAlgorithms file:/Volumes/Data/corpus/proton_wikipedia/ file:/Volumes/Dev/temp/ontology.owl
